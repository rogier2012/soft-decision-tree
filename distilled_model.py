...
class DistilledSoftDecisionTree(nn.Module):

    def __init__(self, args):
        super(DistilledSoftDecisionTree, self).__init__()
        self.args = args
    ...
    def save_best(self, path):
        ...
        with open(os.path.join(path, 'distilled_best_model.pkl'), 'wb') as output_file:
